...
const TransactionsTableModal = () => {
  ...
  const { isTransactionModalOpen: isOpen, closeTransactionModal: closeModal, mode } = useTransactionTableStore();
  ...
  if (isMobile) {
    return (
      <Drawer open={isOpen} onOpenChange={closeModal}>
        <DrawerContent className="max-h-[calc(100dvh-50px)] !h-auto" aria-describedby={undefined}>
          <DrawerHeader>
            <DrawerTitle className="text-xl lg:text-2xl text-center">{actionLabel} your transaction</DrawerTitle>
          </DrawerHeader>
  ...
  return (
    <Dialog open={isOpen} onOpenChange={closeModal}>
      <DialogContent className="min-w-[600px] max-h-[calc(100dvh-50px)] flex flex-col" aria-describedby={undefined}>
        <DialogHeader>
          <DialogTitle className="text-xl lg:text-2xl pl-1">{actionLabel} your transaction</DialogTitle>
        </DialogHeader>
